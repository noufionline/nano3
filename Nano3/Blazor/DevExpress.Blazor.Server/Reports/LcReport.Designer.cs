...
namespace DevExpress.Blazor.Server.Reports {
    
    public partial class LcReport : DevExpress.XtraReports.UI.XtraReport {
        private void InitializeComponent() {
            DevExpress.XtraReports.ReportInitializer reportInitializer = new DevExpress.XtraReports.ReportInitializer(this, "DevExpress.Blazor.Server.Reports.LcReport.repx");
