    ...
    public static class ChangeTrackingExtensions
    {
        ...
        public static void MergeChanges<TEntity>(this ChangeTrackingCollection<TEntity> changeTracker,
            params TEntity[] updatedItems)
                where TEntity : class,IEntity,IDirty, ITrackable, IIdentifiable, INotifyPropertyChanged
        {
            // Check for no items
        ...
        public static ChangeTrackingCollection<TEntity> CloneEntity<TEntity>(this ChangeTrackingCollection<TEntity> changeTracker)
                where TEntity : class,IEntity,IDirty, ITrackable, INotifyPropertyChanged
        {
