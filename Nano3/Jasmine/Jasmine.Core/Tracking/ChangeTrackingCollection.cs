...
namespace Jasmine.Core.Tracking
{
        ...
        where TEntity : class, IEntity, ITrackable, INotifyPropertyChanged
    {
        ...
        /// </summary>
        public void SetTracking(bool value, ObjectVisitationHelper visitationHelper, bool oneToManyOnly, EventHandler<EntityChangedEventArgs> entityChanged = null)
        {
            ...
            foreach (TEntity item in this)
            {
                ...
                (item as IIdentifiable)?.SetEntityIdentifier();
        ...
        private void OnPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            if (Tracking)
            {
                ...
                var unWantedProperties = new[]
                {
                    ...
                    Constants.TrackingProperties.IsDirty,
                    Constants.TrackingProperties.HasErrors,
                    Constants.TrackingProperties.Validators
                };
                if (!ExcludedProperties.Contains(e.PropertyName) && !unWantedProperties.Contains(e.PropertyName))
                {
                    ...
                    if (entity.TrackingState == TrackingState.Unchanged)
                    {
                        ...
                        EntityChanged?.Invoke(this, new EntityChangedEventArgs(entity, null, e.PropertyName));
                    }
        ...
        protected override void InsertItem(int index, TEntity item)
        {
            if (Tracking)
            {
                ...
                EntityChanged?.Invoke(this, new EntityChangedEventArgs(item, Parent, null));
            }
        ...
        protected override void RemoveItem(int index)
        {
            ...
            if (Tracking)
            {
                ...
                if (item.TrackingState != TrackingState.Added
                    && !manyToManyAdded
                    && !_deletedEntities.Contains(item) && item.Id > 0)
                {
        ...
        public ChangeTrackingCollection<TEntity> GetChanges()
        {
            ...
            try
            {
                var changes = CloneChangesHelper.GetChanges(this);
                return changes;
            }
            finally
            {
            ...
            protected override JsonProperty CreateProperty(MemberInfo member, MemberSerialization memberSerialization)
            {
                ...
                property.ShouldSerialize =
                    instance =>
                    {
                        ...
                        EntityNavigationProperty np = entity?.GetNavigationProperties(false)
